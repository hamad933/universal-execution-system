...
class TerminalResultMaterializationTests(unittest.TestCase):
        ...
        findings = [
            {
                ...
                "path": "app/a.py",
                "locator": "L10",
                "detail": "first actionable finding",
                "recommended_remediation": "fix A",
            ...
            },
            {
                ...
                "severity": "medium",
                "resource": "page:S01",
                "detail": "second actionable finding",
    ...
    def test_malformed_handoff_fails_closed(self):
        candidate = extract_terminal_candidate(
            [{"agentMessaged": {"agentMessage": "<UES_HANDOFF_V1>{bad json}</UES_HANDOFF_V1>"}}]
        )
    ...
    def test_legacy_completed_without_marker_is_explicitly_unstructured(self):
        candidate = extract_terminal_candidate(
            [{"agentMessaged": {"agentMessage": "legacy reviewer prose only"}}]
        )
